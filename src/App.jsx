...
import Lenis from '@studio-freight/lenis'; // Ensure this is installed: npm i @studio-freight/lenis
...
// Toggle these to instantly apply or revert global changes
// ==========================================
const SYSTEM_CONFIG = {
  enableSmoothScroll: true,       // Fluid momentum scrolling
  enableFilmGrain: true,          // 3% opacity noise overlay
  enableBootSequence: true,       // Terminal text preloader
  enableAmbientBackground: true,  // Breathing UI lights
  supabaseUrl: 'YOUR_SUPABASE_PROJECT_ID.supabase.co' // Replace with your actual project URL for pre-connecting
};
...
// --- COMPONENT: Animated Routes + Accessibility Announcer ---
    ...
    <Router>
      <LazyMotion features={domAnimation}>
        ...
        <div ref={containerRef} className="relative min-h-screen bg-[#030303] text-zinc-400 font-sans selection:bg-zinc-800 selection:text-white overflow-x-hidden" onMouseMove={handleMouseMove}>
          ...
          {/* BACKGROUND LAYERS - GPU MEMORY OPTIMIZED (backface-hidden added) */}
