      ...
      <LazyMotion features={domAnimation}>
        ...
        <div ref={containerRef} className="relative min-h-screen bg-[#030303] text-zinc-400 font-sans selection:bg-zinc-800 selection:text-white overflow-x-hidden" onMouseMove={handleMouseMove}>
          ...
          <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
            <m.div animate={{ scale: [1, 1.1, 1], opacity: [0.4, 0.6, 0.4] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] rounded-full bg-zinc-800/10 blur-[120px] will-change-transform transform-gpu" />
            <m.div animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }} className="absolute bottom-[-10%] right-[-20%] w-[50%] h-[50%] rounded-full bg-zinc-700/5 blur-[100px] will-change-transform transform-gpu" />
          </div>
          ...
          <nav className="fixed w-full z-50 top-0 border-b border-zinc-800/50 bg-[#030303]/70 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
              ...
              {/* ACCESSIBILITY FOCUS-VISIBLE CLASSES ADDED */}
              ...
              <div className="space-x-8 text-sm uppercase tracking-wider hidden md:flex items-center relative z-50">
                ...
                {isOwner && (
                  <Link to="/admin" className="text-emerald-500 hover:text-emerald-400 font-bold transition-colors border-l border-zinc-800 pl-8 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-sm">
                    ADMIN
                  </Link>
                )}
              </div>
              ...
              <button 
                ...
                className="md:hidden text-zinc-400 hover:text-white z-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-sm" 
